  ...
  implements Omit<Market, 'static' | 'address'>
{
  ...
  constructor(root: RootStore, data: Market) {
    ...
    // initialize long/short token/pools when initializing MarketEntity
    // don't wrap this in a function so these will never be undefined
    // and can be used directly without checking like this: `if(longToken === undefined) return`
