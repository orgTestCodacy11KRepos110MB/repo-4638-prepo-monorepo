...
| apps/smart-contracts/core/Collateral.sol                          | 132  | Collateral for trading on PrePO Markets                                                                                                                                                        | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/DepositHook.sol                         | 73   | Swappable hook for extending `Collateral`'s `deposit` function                                                                                                                                 | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/DepositRecord.sol                       | 64   | Keeps track of global and user deposits for `Collateral`                                                                                                                                       | [`@openzeppelin/*`](https://openzeppelin.com/contracts/) [`@uniswap/v3-periphery`](https://github.com/Uniswap/v3-periphery) |
| apps/smart-contracts/core/DepositTradeHelper.sol                  | 32   | Helper function for minting `Collateral` and swapping into PrePOMarket Uniswap pools                                                                                                           | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/LongShortToken.sol                      | 12   | Token representing PrePOMarket positions.                                                                                                                                                      | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/ManagerWithdrawHook.sol                 | 42   | Swappable hook for extending `Collateral`'s `managerWithdraw` function                                                                                                                         | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/MintHook.sol                            | 16   | Swappable hook for extending `PrePOMarket`'s `mint` function                                                                                                                                   | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/PrePOMarket.sol                         | 161  | Issues new positions for a PrePO Market and allows users to redeem them back for `Collateral`                                                                                                  | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/PrePOMarketFactory.sol                  | 50   | Contract factory for deploying new `PrePOMarket`'s                                                                                                                                             | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/RedeemHook.sol                          | 28   | Swappable hook for extending `PrePOMarket`'s `redeem` function                                                                                                                                 | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/TokenSender.sol                         | 79   | Sends tokens based on an input amount and price oracle, used for reimbursing platform fees in `PPO` token.                                                                                     | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
| apps/smart-contracts/core/WithdrawHook.sol                        | 155  | Swappable hook for extending `Collateral`'s `withdraw` function                                                                                                                                | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)                                                                    |
...
| apps/smart-contracts/core/interfaces/ICollateral.sol                          |                                                                                                                                                               | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)           |
| apps/smart-contracts/core/interfaces/ICollateralHook.sol                      | Base interface for all hooks that extend `Collateral` functions                                                                                               |
| apps/smart-contracts/core/interfaces/IDepositHook.sol                         |                                                                                                                                                               |
| apps/smart-contracts/core/interfaces/IDepositRecord.sol                       |                                                                                                                                                               |
| apps/smart-contracts/core/interfaces/IDepositRecordHook.sol                   | Interface for a hook that reads/writes to a `DepositRecord`                                                                                                   |
| apps/smart-contracts/core/interfaces/IDepositTradeHelper.sol                  |                                                                                                                                                               | [`@uniswap/v3-periphery`](https://github.com/Uniswap/v3-periphery) |
| apps/smart-contracts/core/interfaces/ILongShortToken.sol                      |                                                                                                                                                               | [`@openzeppelin/*`](https://openzeppelin.com/contracts/)           |
| apps/smart-contracts/core/interfaces/IManagerWithdrawHook.sol                 |                                                                                                                                                               |
| apps/smart-contracts/core/interfaces/IMarketHook.sol                          | Base interface for all hooks that extend `PrePOMarket` functions                                                                                              |                                                                    |
| apps/smart-contracts/core/interfaces/IPrePOMarket.sol                         |                                                                                                                                                               |
| apps/smart-contracts/core/interfaces/IPrePOMarketFactory.sol                  |                                                                                                                                                               |
| apps/smart-contracts/core/interfaces/IWithdrawHook.sol                        |                                                                                                                                                               |
...
- Total SLoC for these contracts?:  962 (not including interfaces/imports)
